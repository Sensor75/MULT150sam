...
public class GameManager : MonoBehaviour
{
    ...
    void SlowWorldDown()
    {
        // Cancel any existing invokes to speed the world up
    ...
    void OnGUI()
    {
        if (!isGameOver)
        {
            ...
            Rect labelRect = new Rect(Screen.width / 2 - 10, Screen.height - 80, 100, 40);
        ...
        else
        {
            ...
            Rect labelRect = new Rect(Screen.width / 2 - 55, Screen.height / 2 - 80, 120, 40);
